...
import { Info, FolderClosed, Cpu, Mail, Settings, MessageSquare, Gamepad2 } from 'lucide-react'

export type WindowId = 'about' | 'projects' | 'skills' | 'contact' | 'settings' | 'chat' | 'minigames'
